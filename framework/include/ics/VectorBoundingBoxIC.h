...
class VectorBoundingBoxIC;
class InputParameters;

template <>
InputParameters validParams<VectorBoundingBoxIC>();

/**
 * VectorBoundingBoxIC allows setting the initial condition of a value inside and outside of a specified
 ...
 */
class VectorBoundingBoxIC : public VectorInitialCondition
{
public:
  static InputParameters validParams();

  VectorBoundingBoxIC(const InputParameters & parameters);
